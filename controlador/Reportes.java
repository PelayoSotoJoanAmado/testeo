...
public class Reportes {
    ...
    *********************************************************************** */
    public void ReportesClientes() {
        ...
        if (!directorio.exists()) {
         ...
         PdfWriter.getInstance(documento, new FileOutputStream(rutaOneDrive + "Reporte_Clientes.pdf"));
            ...
            parrafo.setFont(FontFactory.getFont("LIMA", 18, Font.BOLD, BaseColor.DARK_GRAY));
    ...
    public void ReportesProductos() {
        ...
        if (!directorio.exists()) {
            directorio.mkdirs();
             ...
             PdfWriter.getInstance(documento, new FileOutputStream(rutaOneDrive + "Reporte_Productos.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesCategorias() {
        ...
        PdfWriter.getInstance(documento, new FileOutputStream(rutaOneDrive + "Reporte_Categorias.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesVentas() {
        ...
        PdfWriter.getInstance(documento, new FileOutputStream(rutaOneDrive + "Reporte_Ventas.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
