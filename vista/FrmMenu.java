...
import vista.InterNotificacionesReabastecimiento;
import vista.InterHistorialMovimientos;
...
public class FrmMenu extends javax.swing.JFrame {
    ...
    public Image getIconImage() {
        Image retValue = Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("img/r de ropatech.png"));
        return retValue;
    }
    */
    /**
    ...
    private void initComponents() {
        ...
        jMenuItem_historial_movimientos = new javax.swing.JMenuItem();
        jMenu9 = new javax.swing.JMenu();
        jMenuItem_notificaciones = new javax.swing.JMenuItem();
        jMenuItem_diagnostico = new javax.swing.JMenuItem();
        ...
        jMenuItem_ver_historial.setText("Ventas");
        ...
        jMenuItem_historial_movimientos.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_historial_movimientos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/movimientos.png"))); // NOI18N
        jMenuItem_historial_movimientos.setText("Movimientos");
        jMenuItem_historial_movimientos.setPreferredSize(new java.awt.Dimension(150, 30));
        jMenuItem_historial_movimientos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_historial_movimientosActionPerformed(evt);
            }
        });
        jMenu7.add(jMenuItem_historial_movimientos);

        jMenuBar1.add(jMenu7);

        jMenu9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/notis.png"))); // NOI18N
        jMenu9.setText("Notificaciones");
        jMenu9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jMenu9.setPreferredSize(new java.awt.Dimension(150, 50));

        jMenuItem_notificaciones.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_notificaciones.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/notis.png"))); // NOI18N
        jMenuItem_notificaciones.setText("Ver Notificaciones");
        jMenuItem_notificaciones.setPreferredSize(new java.awt.Dimension(150, 30));
        jMenuItem_notificaciones.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_notificacionesActionPerformed(evt);
            }
        });
        jMenu9.add(jMenuItem_notificaciones);

        jMenuItem_diagnostico.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_diagnostico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/diagnostico.png"))); // NOI18N
        jMenuItem_diagnostico.setText("Diagnostico");
        jMenuItem_diagnostico.setPreferredSize(new java.awt.Dimension(150, 30));
        jMenuItem_diagnostico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_diagnosticoActionPerformed(evt);
            }
        });
        jMenu9.add(jMenuItem_diagnostico);
    ...
    private void jMenuItem_notificacionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_notificacionesActionPerformed
        InterNotificacionesReabastecimiento interNotificacionesReabastecimiento = new InterNotificacionesReabastecimiento();
        jDesktopPane_menu.add(interNotificacionesReabastecimiento);
        interNotificacionesReabastecimiento.setVisible(true);
    }//GEN-LAST:event_jMenuItem_notificacionesActionPerformed

    private void jMenuItem_historial_movimientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_historial_movimientosActionPerformed

        
        InterHistorialMovimientos interHistorialMovimientos = new InterHistorialMovimientos();
        jDesktopPane_menu.add(interHistorialMovimientos);
        interHistorialMovimientos.setVisible(true);
    }//GEN-LAST:event_jMenuItem_historial_movimientosActionPerformed

    private void jMenuItem_diagnosticoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_diagnosticoActionPerformed
        InterDiagnostico interDiag = new InterDiagnostico();
        jDesktopPane_menu.add(interDiag);
        interDiag.setVisible(true);
    }//GEN-LAST:event_jMenuItem_diagnosticoActionPerformed
    ...
    private javax.swing.JMenuItem jMenuItem_diagnostico;
    ...
    private javax.swing.JMenuItem jMenuItem_historial_movimientos;
    private javax.swing.JMenuItem jMenuItem_notificaciones;
